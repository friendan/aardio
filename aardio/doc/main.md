...
在代码编辑器仅选中库、库函数、特殊符号或标记然后按 `F1` 键可打开相关文档，选中其他代码按 `F1` 键则打开 AI 搜索，选中任意内容按 `Shift + F1` 键可打开 AI 聊天助手。在所有文档页面『划选』内容后可点击上方显示的『问 AI』搜索答案。

[增强检索与 AI 提示词工具](https://www.aardio.com/zh-cn/ai/prompt/)
