...
7. UTF-8 编码
    ...
    */
    ...
    - 将 11001010 拆分为 00011 001010，位数不足在前面补 0。
    - 将后半部分 001010 填充到 110xxxxx 10xxxxxx 前面变成 110xxxxx 10001010
    - 将前半部分 00011 填充到 110xxxxx 10001010 前面变成 11000011 10001010，不足在前面补 0。 

    Unicode 0800 ~FFFF 转换为UTF8需要2字节，例如`\uF03F (11110000 0011111)` 转换为UTF8过程如下：  
    - 将 11110000 0011111 拆分为 1111 000000 111111，位数不足在前面补 0。
    - 将最后部分 111111 填充到 1110xxxx 10xxxxxx 10xxxxxx 前面变成 1110xxxx 10xxxxxx 10111111
    - 将中间部分 000000 填充到  1110xxxx 10xxxxxx 10111111
    前面变成 1110xxxx 10000000 10111111
    ，不足在前面补 0。
    - 将最前部分 1111 填充到 1110xxxx 10000000 10111111 前面变成  11101111 10000000 10111111。
